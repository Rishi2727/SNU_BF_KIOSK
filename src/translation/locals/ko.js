const koTranslations = {
  speech: {
    ...
    To: "로.",
    Total: "총",
    "This screen is the floor or reading room selection screen.": "층 선택 화면입니다. 중앙의 메인 지도에는 좌석 예약을 위한 구역 선택이 가능한 다양한 영역이 표시됩니다. 하단에서는 층(6층, 7층, 8층)을 전환할 수 있으며 좌석 이용 가능 여부를 확인할 수 있습니다. 왼쪽 하단에는 현재 시간, 로그아웃 버튼, 사용자 이름, 언어 선택이 표시됩니다. 오른쪽 하단에는 기능 버튼이 다음 순서로 배치되어 있습니다: 볼륨 낮추기, 현재 볼륨, 볼륨 높이기 정보,돋보기 .대비. 숫자 키패드의 * 키를 사용하여 화면의 모든 영역을 선택할 수 있습니다. 좌우에 있는 탐색 화살표를 사용하여 지도를 이동할 수 있습니다. 계속 진행하려면 지도에서 원하는 구역을 선택해 주세요.",
    "This screen is the main screen.":
      "메인 화면입니다. 중앙에는 도서관 선택 버튼이 있으며, 그 아래에는 공지사항이 표시됩니다. 화면 왼쪽 하단에는 현재 시간과 로그인 버튼이 있고, 그 다음으로 언어 선택 버튼이 있습니다. 화면 오른쪽 하단에는 기능 버튼이 다음 순서로 배치되어 있습니다: 볼륨 낮추기, 현재 볼륨, 볼륨 높이기, 정보,돋보기, 고대비. 숫자 키패드의 * 키를 사용하여 화면의 모든 색션을  선택할 수 있습니다. 도서관을 선택하려면 중앙에서 ‘도서관'을 선택해 주세요. 도움이 필요하시면 관리자에게 문의하시기 바랍니다",
    ...
    GREATER_THAN: "보다 큼",
    Sector: "섹터",
    "SEAT_MODAL_EXTENSION_CONFIRM" : "좌석을 연장 하시겠습니까?",
    "dateDurationRange": "날짜 기간: {{start}}부터 {{end}}까지",
    "to" : "까지",
    1: "일",
    2: "이",
    3: "삼",
    ...
    LANGUAGE_NOTICES_DESC:
      "사용자는 언어를 변경하고 규칙, 시설 이용, 업데이트에 대한 공지를 확인할 수 있습니다.",
    DATE_TIME_FLOOR: "날짜, 시간 및 층 정보",
    DATE_TIME_FLOOR_DESC:
      "대시보드에는 현재 날짜, 시간 및 층 정보가 표시됩니다.",
    LOGIN_METHODS: "로그인 방법",
    LOGIN_METHODS_DESC:
      "수동 아이디 입력, QR 코드 스캔 또는 RFID 학생증 인식을 통해 로그인할 수 있습니다.",
    NAVIGATION_BOOKING: "이동 및 좌석 예약",
    NAVIGATION_BOOKING_DESC:
      "사용자는 사이드바 또는 지도를 통해 층을 선택하고 방을 고른 후 좌석을 예약할 수 있습니다.",
    FOOTER_TOOLS: "바닥글 도구",
    FOOTER_TOOLS_DESC:
      "바닥글 버튼을 통해 볼륨, 확대 기능, 대비 모드 및 시스템 정보를 제어할 수 있습니다.",
    BOOKING_POPUPS: "예약 팝업",
    BOOKING_POPUPS_DESC:
      "좌석 및 방 예약 시 확인, 취소, 반납, 연장 및 내 예약에 대한 팝업이 표시됩니다.",
    GATE_CONFIRMATION: "게이트 기반 확인",
    GATE_CONFIRMATION_DESC:
      "게이트 내부에서는 예약이 자동으로 확인되며, 게이트 외부에서는 키오스크 확인이 필요합니다.",
    GROUP_ROOM_BOOKING: "그룹룸 예약",
    GROUP_ROOM_BOOKING_DESC:
      "그룹 예약 시 모든 구성원이 RFID 또는 QR 코드를 스캔하여 확인해야 합니다.",
    MULTIPLE_BOOKING: "다중 예약 처리",
    MULTIPLE_BOOKING_DESC:
      "여러 예약이 있는 경우 ‘아니오’ 버튼을 누르면 모든 팝업이 표시될 때까지 다음 팝업으로 이동합니다.",
    Extension: "확대",
    "Central Library": "중앙도서관",
    "Current Time": "현재 시간",
    "Press OK button": "확인 버튼을 눌러 닫으세요.",
    "Volume Up With Percent":
      "볼륨이 증가했습니다. 현재 {{percent}}퍼센트입니다.",
    "Volume Down With Percent":
      "볼륨이 감소했습니다. 현재 {{percent}}퍼센트입니다.",
    ...
    "Login is performed by scanning a membership card, student ID, or other identification card using the RFID reader, or by scanning a barcode or QR code with the barcode/QR scanner.":
      "로그인은 RFID 리더기를 사용하여 회원 카드, 학생증 또는 기타 신분증을 스캔하거나, 바코드/QR 스캐너로 바코드 또는 QR 코드를 스캔하여 수행됩니다.",
    ...
    "After logging in, select a reading room from the reading room selection area, then choose your desired seat to receive a seat ticket.":
      "로그인 후 열람실 선택 영역에서 열람실을 선택한 다음, 원하는 좌석을 선택하여 좌석 티켓을 발급받으십시오.",
    ...
    "After logging in, go to the reading room selection area, select the room where you are seated, and follow the instructions to return your seat.":
      "로그인 후 열람실 선택 영역으로 이동하여 현재 이용 중인 열람실을 선택하고 안내에 따라 좌석을 반납하십시오.",
    ...
    "If you need assistance, you can request help from a staff member by using the guide button on the right side of the keypad.":
      "도움이 필요하시면 키패드 오른쪽에 있는 안내 버튼을 사용하여 직원에게 도움을 요청할 수 있습니다.",

    KEYPAD_DIRECTION_BUTTON_GUIDE: "방향 버튼 안내",
    KEYPAD_DIRECTION_BUTTON_GUIDE_MSG:
      "오른쪽 화살표 버튼: 오른쪽으로 포커스 이동\n위쪽 화살표 버튼: 볼륨 증가\n아래쪽 화살표 버튼: 볼륨 감소\n가운데 원형 버튼: 선택 / 확인",

    SPECIAL_KEY_GUIDE: "특수 키 안내",
    SPECIAL_KEY_GUIDE_MSG:
      "삼각형 버튼: 음성 안내 다시 듣기\nX 버튼: 음성 안내 중지",

    NUMERIC_KEYPAD_USAGE_GUIDE: "숫자 키패드 사용 안내",
    NUMERIC_KEYPAD_USAGE_GUIDE_MSG:
    ...
    "This is room page select your desired seat":
      "중앙 도서관 좌석 선택 화면입니다. 중앙의 메인 지도에는 예약 가능한 좌석이 표시됩니다. 하단에서는 층(6층, 7층, 8층)을 전환할 수 있으며 좌석 이용 가능 여부를 확인할 수 있습니다. 왼쪽 하단에는 현재 시간, 뒤로 가기 버튼, 로그아웃 버튼, 사용자 이름, 언어 선택이 표시됩니다. 오른쪽 하단에는 기능 버튼이 다음 순서로 배치되어 있습니다: 볼륨 낮추기, 현재 볼륨, 볼륨 노피기, 정보, 돋보기, 대비. 숫자 키패드의 * 키를 사용하여 화면의 모든 영역을 선택할 수 있습니다. 좌우 탐색 화살표를 사용하여 지도를 이동할 수 있습니다. 계속 진행하려면 지도에서 원하는 좌석을 선택해 주세요.",
  ...
  translations: {
    ...
    "Do you want to extend the seat?" : "좌석을 연장 히시겠습니까?",
    ...
    "Network error. Unable to contact administrator":
      "네트워크 오류로 관리자를 연결할 수 없습니다",
    "Message sent to administrator": "관리자에게 메시지가 전송되었습니다",
    "Failed to send message to administrator":
    ...
    Retry: "다시 해 보다",
    "Quiet Zone": "정숙 구역",
    "Another seat is already in use (reserved).":
      "이미 다른 좌석을 사용(예약)중입니다.",
    "이미 다른 좌석을 사용(예약)중입니다.":
      "이미 다른 좌석을 사용(예약)중입니다.",
    "다른 구역으로는 좌석을 이동할 수 없습니다.<br/>관리자에게 문의하세요.":
      "다른 구역으로는 좌석을 이동할 수 없습니다.관리자에게 문의하세요.",
    "서비스 도중 에러가 발생하였습니다.<BR/>잠시 후 다시 이용하시길 바랍니다.":
      "서비스 도중 에러가 발생하였습니다 잠시 후 다시 이용하시길 바랍니다.",
    ...
    "*Please return the seat assignment when you":
      "*퇴실시 좌석을 반납해 주시면.",
    "-check out.": "-체크아웃하세요.",
    "Please return the seat assignment when you":
      "좌석 배정표는 도착 시 반납해 주시기 바랍니다.",
    "*It helps other people use it.":
      "*다른 사람들이 사용하는 데 도움이 됩니다.",
    ...
    "This self-service kiosk by Wise Neosco India Pvt. Ltd. simplifies seat reservations, confirmations, cancellations, returns, and extensions. It also works with RFID, QR codes, and barcodes for fast, secure access.":
      "Wise Neosco India Pvt. Ltd.에서 개발한 이 셀프 서비스 키오스크는 좌석 예약, 확인, 취소, 반환 및 연장을 간소화합니다. 또한 RFID, QR 코드 및 바코드를 사용하여 빠르고 안전한 접근을 지원합니다.",
    Date: "날짜",
    "Print": "인쇄",
    "Seat Booking": "좌석 예약",
    "Seat Extension": "좌석 연장",
