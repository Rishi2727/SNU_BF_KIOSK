const koTranslations = {
  speech: {
    ...
    "This screen is the main screen.": "현재 화면은 메인 화면입니다. 화면 가운데에는 도서관 선택 버튼이 있으며, 아래에는 공지 사항이 표시됩니다. 화면 왼쪽 아래에는 로그인 버튼이 있습니다. 로그인 버튼 옆에는 언어 선택 버튼이 있습니다. 화면 하단 오른쪽에는 기능 버튼들이 순서대로 있습니다. 음량 낮추기, 현재 음량, 음량 높이기, 이용 안내, 돋보기, 고대비 버튼 순서 입니다. 숫자 키패드의 * 버튼을 통해 화면 구역을 선택할 수 있습니다. 도서관을 선택하려면 가운데의 신관을 선택해 주세요. 필요한 사항이 있다면 관리자를 호출해주세요.",
